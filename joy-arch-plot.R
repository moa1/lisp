...
matplot(t[,seq(fits+1,fits+mut_length_const*2,2)], type="b", cex=0.25)
matplot(t[,seq(fits+2,fits+mut_length_const*2,2)], type="b", cex=0.25)
# plot joy-ops frequencies
matplot(t[,seq(fits+mut_length_const*2+1,length(t),2)], type="b", cex=0.25)
matplot(t[,seq(fits+mut_length_const*2+2,length(t),2)], type="b", cex=0.25)
dev.off()
