...
(defstruct normal-card
  ...
  (multisingle :undef :type (member :multi :single))
...
;;;; Insert file '~/tmp/mk.lisp' generated by machikoro-parse-cards.py here. Its end is at ;;;; END
(let* ((placeholder (make-normal-card :dice '(1) :cost 0 :multisingle :multi))
